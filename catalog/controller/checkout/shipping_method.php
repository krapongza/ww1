...
class ControllerCheckoutShippingMethod extends Controller {
  	public function index() {
		...
		if (!empty($payment_address)) {
			...
			$a = array('title'=>"Flat Shipping Rate" , 'code'=>"flat.flat" , 'cost'=>"5.00" , 'tax_class_id'=>"9" , 'text'=> "$5.00" );
			$b = array($a);
			$this->session->data['shipping_methods'] = $b; //$quote_data;
			/*
			shipping_methods[0]
			code: "flat.flat"
			cost: "5.00"
			...
			*/
			...
			$a = array('title'=>"Flat Shipping Rate" , 'code'=>"flat.flat" , 'cost'=>"5.00" , 'tax_class_id'=>"9" , 'text'=> "$5.00" );
			$b = array($a);
			$this->session->data['shipping_methods'] = $aaa; //$quote_data;
	...
	public function validate() {
		...
		if (!$json) {
			...
			if (!$json) {
				...
				//$json['error']['warning'] = $this->session->data['shipping_method'];
