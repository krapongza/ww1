...
class ModelSaleCustomer extends Model {
	...
	public function editCustomer($customer_id, $data) {
		...
		$this->db->query("UPDATE " . DB_PREFIX . "customer SET firstname = '" . $this->db->escape($data['firstname']) . "', lastname = '" . $this->db->escape($data['lastname']) . "', email = '" . $this->db->escape($data['email']) . "' ,  birthday = '" . $this->db->escape($tmp_date) . "' ,  gender = '".$this->db->escape($data['gender'])."', mobile = '".$this->db->escape($data['mobile'])."', telephone = '".$this->db->escape($data['telephone'])."', facebook = '".$this->db->escape($data['facebook'])."', line = '".$this->db->escape($data['line'])."', fax = '', newsletter = '0', customer_group_id = '1', status = '" . (int)$data['status'] . "' WHERE customer_id = '" . (int)$customer_id . "'");
