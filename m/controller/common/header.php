...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['bank'] = $this->url->link('catalog/bank', 'token=' . $this->session->data['token'], 'SSL');
			...
			$this->data['product_size'] = $this->url->link('catalog/option/update', 'token=' . $this->session->data['token'] . "&option_id=11", 'SSL');
			$this->data['product_color'] = $this->url->link('catalog/option/update', 'token=' . $this->session->data['token'] . "&option_id=2", 'SSL');
			...
			$this->data['discount']					= $this->url->link('sale/discount', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['wishlist']					= $this->url->link('catalog/wishlist', 'token=' . $this->session->data['token'], 'SSL');

			$this->data['text']						= $this->url->link('catalog/text', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['product_table']			= $this->url->link('catalog/product/table', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['product_feature']			= $this->url->link('module/featured', 'token=' . $this->session->data['token'], 'SSL');
			
			$this->data['sale_rollback']			= $this->url->link('sale/order/rollbacklist', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['sale_cancellist']			= $this->url->link('sale/order/cancellist', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['sale_refund']				= $this->url->link('sale/order/refundlist', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['packing_list']				= $this->url->link('sale/packing', 'token=' . $this->session->data['token'], 'SSL');

			$this->data['report']							= $this->url->link('sale/report', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['report_sale_whobuy']				= $this->url->link('report/sale_order/whobuy', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['topbestbuy']					= $this->url->link('report/customer_order/topbestbuy', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['topworstbuy']					= $this->url->link('report/customer_order/topworstbuy', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['allProduct']					= $this->url->link('report/customer_order/allProduct', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['customer_info']				= $this->url->link('report/customer_order/customerinfo', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['registerdaily']				= $this->url->link('report/customer_order/registerdaily', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['registermonthly']				= $this->url->link('report/customer_order/registermonthly', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['hideproduct']					= $this->url->link('report/product_viewed/moreproducthiding', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['suppliercomingsoon']			= $this->url->link('report/product_viewed/suppliercomingsoon', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['report_product_specialcost']	= $this->url->link('report/product_viewed/specialcost', 'token=' . $this->session->data['token'], 'SSL');

			$this->data['ticket_department']		= $this->url->link('simple_support/department', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['ticket_customer_ticket']	= $this->url->link('simple_support/customer_ticket', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['ticket_admin_ticket']		= $this->url->link('simple_support/admin_ticket', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['faq']						= $this->url->link('simple_support/faq', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['faq_group']				= $this->url->link('simple_support/faq_group', 'token=' . $this->session->data['token'], 'SSL');



			$data = array();
			$this->load->model('sale/order');
			$this->data['cancelorder'] = $this->model_sale_order->getTotalCancelOrdersHeader($data);
			$this->data['refundorder'] = $this->model_sale_order->getTotalRefundOrdersHeader($data);
