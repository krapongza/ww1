...
class ControllerSaleCustomer extends Controller { 
	...
	public function approve() {
  	...
  	protected function getList() {
		...
		/*if (isset($this->request->get['filter_customer_group_id'])) {
			$url .= '&filter_customer_group_id=1' ;
		}
		if (isset($this->request->get['filter_status'])) {
			$url .= '&filter_status=' . $this->request->get['filter_status'];
		}
  	...
  	protected function getForm() {
		...
		$this->data['error_address_firstname']	= (isset($this->error['address_firstname'])) ? $this->error['address_firstname'] : '';
		$this->data['error_address_lastname']	= (isset($this->error['address_lastname'])) ? $this->error['address_lastname'] : '';
		$this->data['error_address_tax_id']		= (isset($this->error['address_tax_id'])) ? $this->error['address_tax_id'] : '';
		$this->data['error_address_address_1']	= (isset($this->error['address_address_1'])) ? $this->error['address_address_1'] : '';
		$this->data['error_address_city']		= (isset($this->error['address_city'])) ? $this->error['address_city'] : '';
		$this->data['error_address_postcode']	= (isset($this->error['address_postcode'])) ? $this->error['address_postcode'] : '';
		$this->data['error_address_country']	= (isset($this->error['address_country'])) ? $this->error['address_country'] : '';
		$this->data['error_address_zone']		= (isset($this->error['address_zone'])) ? $this->error['address_zone'] : '';
